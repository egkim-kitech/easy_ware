...
checkbox3 = CheckboxWithProcess(mapping_frame, text="Voxel_Grid_Sampler(Mendatory)", node="easy_ware", script="points_downsample.launch")
...
checkbox4_1 = CheckboxWithProcess(rviz_frame, text="easy_Rviz_launcher", node="easy_ware", script="easy_rviz.launch")
checkbox4_1.grid(row=2, column=3)
...
sensor_title_label1.grid(row=0, column=1, sticky="w")


sensor_title_label2 = tkinter.Label(sensor_frame, text="GPS_node", font=("Arial", 11, "bold"))
sensor_title_label2.grid(row=1, column=0, sticky="w")
...
sensor_title_label3.grid(row=3, column=0, sticky="w")
